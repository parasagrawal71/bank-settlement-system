...
func LoadDbConfigFromEnv() DBConfig {
	return DBConfig{
		DBHost:     env.GetEnvString("PAYMENTS_DB_HOST", ""),
		DBUser:     env.GetEnvString("PAYMENTS_DB_USER", ""),
		DBPassword: env.GetEnvString("PAYMENTS_DB_PASSWORD", ""),
		DBName:     env.GetEnvString("PAYMENTS_DB_NAME", ""),
		DBPort:     env.GetEnvString("PAYMENTS_DB_PORT", ""),
...
func Load() *Config {
	...
	port := env.GetEnvString("PAYMENTS_GRPC_PORT", "")
