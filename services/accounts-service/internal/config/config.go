...
func LoadDbConfigFromEnv() DBConfig {
	return DBConfig{
		DBHost:     env.GetEnvString("ACCOUNTS_DB_HOST", ""),
		DBUser:     env.GetEnvString("ACCOUNTS_DB_USER", ""),
		DBPassword: env.GetEnvString("ACCOUNTS_DB_PASSWORD", ""),
		DBName:     env.GetEnvString("ACCOUNTS_DB_NAME", ""),
		DBPort:     env.GetEnvString("ACCOUNTS_DB_PORT", ""),
...
func Load() *Config {
	...
	port := env.GetEnvString("ACCOUNTS_GRPC_PORT", "")
